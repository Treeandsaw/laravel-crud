...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/">Tree&Saw.com</a>
    </div>
    ...
    {{ Form::open(['route' => 'search', 'method' => 'GET', 'class'=>'navbar-form navbar-left '])}} 
        ...
        {{ Form::submit('Save', array('class' => 'btn btn-primary openbutton')) }}
    {{ Form::close() }}
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        @else
          ...
          <li class="{{ Request::is('login') ? "active" : "" }}">{!! Html::linkroute('register', 'Register') !!}</li>
        @endif
      </ul>
